...
export default function BloodDonationForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      alert('Blood donation pledge form submitted successfully!');
    },
  });
  ...
  const hasBloodGroupError = formik.touched.bloodGroup && formik.errors.bloodGroup;
    ...
    <div className=" lg:my-10 my-5">
      <div className="container">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-lg font-semibold text-gray-800">FOR BLOOD PLEDGING</h2>
        ...
        <div onSubmit={formik.handleSubmit}>
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <InputField placeholder="Full Name" label="Full Name" name="fullName" formik={formik} className="!focus:ring-0 !focus:outline-none" />
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            <div className="mb-4">
              <label className="text-sm font-semibold text-primary mb-2 block ">Please Choose Your Blood Group</label>
              <div className="flex flex-wrap gap-4">
                {['A+', 'A-', 'AB+', 'AB-', 'O'].map((group) => (
                  <label key={group} className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="radio"
                      name="bloodGroup"
                      value={group}
                      checked={formik.values.bloodGroup === group}
                      onChange={formik.handleChange}
                      onBlur={formik.handleBlur}
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              ...
              <div className="flex flex-col col-span-2">
                <label className="text-sm font-medium text-gray-700 mb-1">Upload Your Signature </label>
                <div className="border-2 border-dashed border-gray-300 bg-white rounded-lg p-6 text-center ">
                  ...
                  <label htmlFor="signature-upload" className="cursor-pointer">
                    ...
                    <span className="text-sm text-gray-500 hover:text-primary">Upload a Signature of Pledge</span>
                  </label>
                  {signatureFile && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <InputField label="Address for correspondence" name="correspondenceAddress" placeholder="Full Address" formik={formik} />
              <InputField label="Mobile No" name="telephoneNo" placeholder="Mobile No" formik={formik} />
              <InputField label="Email" name="email" type="email" formik={formik} placeholder="Email" />
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <InputField label="Full Name" name="witness1FullName" formik={formik} placeholder='Full Name' />
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <InputField label="Full Name" name="witness2FullName" placeholder='Full Name' formik={formik} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <InputField label="Enter Your Date Of Birth" name="witness2DateOfBirth" placeholder='DOB' type="date" formik={formik} />
              <InputField label="Enter Your Full Address" name="witness2Address" placeholder="Enter Your Full Address" formik={formik} />
              <InputField label="Mobile No" name="witness2MobileNo" placeholder="Street" formik={formik} />
            </div>
